...
class TestProfile(TestCase):
    def setUp(self):
        self.user = User(id=1, username='carol', password='1234')
        self.user.save()
...
class ProjectTest(TestCase):
    def setUp(self):
        self.user = User.objects.create(id=1, username='carol')
        self.project = Project.objects.create(id=1, title='test project', image='https://ucarecdn.com/0ccf61ff-508e-46c6-b713-db51daa6626e', description='desc',
